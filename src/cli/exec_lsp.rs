...
mod tests {
    ...
    #[test]
    fn to_lsp_diagnostic_maps_error_severity() {
        let d = Diagnostic {
    ...
    #[test]
    fn to_lsp_diagnostic_maps_warning_severity() {
        let d = Diagnostic {
    ...
    #[test]
    fn to_lsp_diagnostic_converts_1based_to_0based() {
        let d = Diagnostic {
            severity: Severity::Error,
    ...
    #[test]
    fn to_lsp_diagnostic_handles_no_location() {
        let d = Diagnostic {
            severity: Severity::Error,
    ...
    #[test]
    fn to_lsp_diagnostic_handles_no_code() {
        let d = Diagnostic {
            severity: Severity::Error,
